...
export default function (config) {
    return <div>
        <ul className={'big-line-spacing'}>
            <li> Bid price (let's call it <span className={'red'}> "bipcket" </ span> :) - <span
                className={'big2'}> {config.price} </ span> {config.coin}
            </ li>
            <li className={'text-info'}> Transaction with amount less than <strong
                className={'red'}> {config.price} </ strong> {config.coin}
                considered a gift
            </ li>

            <li>
                <h3> Affiliate Program <span className={'big2'}> {config.percent * 100}% </ span></ h3>
                With each <span className={'red'}> bipcket </ span> purchased with your promotional code, you get <span
                className={'big2'}> {config.percent * 100}% </ span> of the amount paid for it.
            </ li>

            <li>
                A <span className={'red'}> bipcket </ span> bought at a price higher than the nominal value increases
            ...
            <li>
                ...
                <ul>
                    ...
                    <li> Transactions with an amount greater than the price of a <span
                        className={'red'}> bipcket </ span> fall into the list as many more times as their sum is
                        greater than the nominal value
                    </ li>
                    <li> Transactions with promo codes are added another {config.promoChance} times</ li>
                    <li> From the resulting list, 1 random transaction is selected and a daily prize is sent to the
            ...
            <li> After you have bought a <span className={'red'}> bipcket </ span>, <strong> transaction
                0 {config.coin} </ strong> comes to your wallet address with
            ...
            <li> Invite new members using your promo code and you will receive {config.percent * 100}%
                with
                each <span className={'red'}> bipcket </ span> purchased (if your promo code is in
