            ...
            <ul className={'big-line-spacing'}>
                <li>
                    ...
                    <strong
                        ...
                        className={'red'}>{this.data.address}</a></strong>
                    {this.data.parentCode &&
                    <li>И в поле <strong>"Message"</strong> укажите мой промокод: <strong className={'big2 red'}>{this.data.parentCode}</strong></li>}
                </li>
                <li>
