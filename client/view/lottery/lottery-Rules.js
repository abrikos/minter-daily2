            ...
            <div>
                <ul className={'big-line-spacing'}>
                    <li>Цена ставки (назовем ее <span className={'red'}>"биплет"</span>:) - <span
                        className={'big2'}>{this.props.data.price}</span> BIP
                    </li>
                    <li className={'text-info'}>Транзакция суммой менее <strong className={'red'}>{this.props.data.price}</strong> BIP
                        считается подарком
                    </li>

                    <li>
                        <h3>Партнерская программа <span className={'big2'}>{this.props.data.percent * 100}%</span></h3>
                        С каждого <span className={'red'}>биплета</span> купленного с Вашим промо-кодом Вы получаете <span
                        className={'big2'}>{this.props.data.percent * 100}%</span> от уплаченной за него суммы.
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>Транзакции с промокодами добавляются еще {this.props.data.promoChance} раза</li>
                    ...
                    <li>
                        Ежедневный приз формируется как <strong className={'red'}>{this.props.data.percentDaily * 100}%</strong> от
                    ...
                    <li>Приглашайте новых участников с помощью Вашего промо-кода и Вы будете получать {this.props.data.percent * 100}%
                        с
